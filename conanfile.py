...
class ArbaItruRecipe(ConanFile):
    project_namespace = "arba"
    project_base_name = "itru"
    ...
    url = "https://github.com/arapelle/arba-itru"
    homepage = "https://github.com/arapelle/arba-itru"
    topics = ("intrusive", "shared-ptr")
    license = "MIT"
